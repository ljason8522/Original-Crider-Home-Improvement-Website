          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-600 text-white py-4 rounded-lg hover:bg-blue-700 transition-colors font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                >
                  Get My Free Quote
                </button>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">What you can expect when you work with us</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <p className="text-gray-600">No-obligation assessment and detailed quote for your project</p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-3">BuildZoom Verified</h3>
              <p className="text-gray-600">Top 37% of Illinois contractors with verified permit history</p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <p className="text-gray-600">Deep knowledge of Quad Cities building codes and requirements</p>
            </div>
          </div>
        </div>
      </section>
